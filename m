...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 29E8FB00162
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=wMusc6IRXcU2Ox8J+hjN1SjJvCoRDQhDPYl41Ofbhyc=; b=B6N692kTdPE1hz7RoKe881Fe3M
	GMXNwov/RNRxZJLM1nnB41CgjbtZZDfr8KZ4BVphm6REM9P5Hj7o1W564iUEsXpqYK0AhKePpmX/f
	YllHE0vhmWyyyNO80YuKB2MZxY5nDUd78gkpDPAIwXuWWnu5qh34rUXSAXC/rAfwp740=;
...
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 ...
 (envelope-from <lihongbo22@huawei.com>) id 1uZqC0-0004Hh-LM
 for linux-f2fs-devel@lists.sourceforge.net;
 Thu, 10 Jul 2025 12:16:00 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=lxxMQGnXVCRnrpNRHCR9HMPsBwyB9v7zJhTOnOEjPQc=; b=EtjuvNn/O6ymhwhir+3I1KKPuP
 KYRCPRPI83GMxTGF7n5C8tC2bAJ/ViVCTuB0j8D4FkPx/Yn/KA98XVzKpCuGThEciSlqJj48QlY/s
 VWlkcvAJ/9eIDuRRWuNhcGA3uEiz/DHwJzu9txNc/LC73z5afnl2R96H7Fs6GA+7DVrI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=lxxMQGnXVCRnrpNRHCR9HMPsBwyB9v7zJhTOnOEjPQc=; b=lnaNYLACGfiqM1HFxyqtDGPLvG
 /hPmXyqmFYkMBp3kmggL//P2lmAy1VTqPilf/eDbo7qgphV1BtzjCzj9IOCGaoqu3xV80Lm9KF0Ba
 xt5wNyRjFBkRQJK1A55v6SnH8HHnz3uRUUEwLNck3LjtB/0LAJksct4UAXaFel8iAchY=;
Received: from szxga01-in.huawei.com ([45.249.212.187])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1uZqBx-00020Z-F8 for linux-f2fs-devel@lists.sourceforge.net;
 Thu, 10 Jul 2025 12:16:00 +0000
Received: from mail.maildlp.com (unknown [172.19.162.254])
 by szxga01-in.huawei.com (SkyGuard) with ESMTP id 4bdDJH5LTGz13Mcn;
 Thu, 10 Jul 2025 20:13:03 +0800 (CST)
Received: from kwepemo500009.china.huawei.com (unknown [7.202.194.199])
 by mail.maildlp.com (Postfix) with ESMTPS id EDE56180466;
...
Date: Thu, 10 Jul 2025 12:14:10 +0000
Message-ID: <20250710121415.628398-3-lihongbo22@huawei.com>
...
X-Headers-End: 1uZqBx-00020Z-F8
Subject: [f2fs-dev] [PATCH v5 2/7] f2fs: move the option parser into
 handle_mount_opt
...
index 713dc55f086b..fddd33b1118c 100644
--- a/fs/f2fs/super.c
+++ b/fs/f2fs/super.c
@@ -27,6 +27,7 @@
...
@@ -4726,7 +4484,7 @@ static int f2fs_fill_super(struct super_block *sb, void *data, int silent)
 	if (err)
 		goto free_options;
