...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 5AC0967F724
	for <lists+linux-f2fs-devel@lfdr.de>; Sat, 28 Jan 2023 11:33:13 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1pLiWF-0005bQ-No;
	Sat, 28 Jan 2023 10:33:11 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <chao@kernel.org>) id 1pLiVu-0005aw-Rp
 for linux-f2fs-devel@lists.sourceforge.net;
 Sat, 28 Jan 2023 10:32:50 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=R9AGV0K+hK32HMyaPq2dPmfIh5dwLE72QNUmw5nv2OQ=; b=cyb2HjnD/L6J6+D5NdCJsMcGFT
 Tw0CiJh1/zpq77ad3H2HecaRcuj9GqfEF9XVvv1TRYKzCv029RSV3y5POtXZ3CgMyEb1f7nTYTAzm
 cz+HX7RvDdJFOkLpL8De6E+7pRAoY2MQDkydB9S6HcSfDKihFCDnsjPMiutgwtnw3Zvo=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=R9AGV0K+hK32HMyaPq2dPmfIh5dwLE72QNUmw5nv2OQ=; b=Q
 pW4cJbX6kWvspgNCBKx841YxXpO+JigxKckO+D/XCv1L8cMY/uSHkEgdp04861iP7rhWSeBbkJYzG
 xq6gBuOUygjMumovyb6sV/4HfA6kRvy4YBkrOMqLYVnSw0vxJbS8+3rskZ0R2pAKQq7+zhkuePr+X
 NSqJS+R1RNRwxlOM=;
Received: from ams.source.kernel.org ([145.40.68.75])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pLiVt-001aZ8-Dp for linux-f2fs-devel@lists.sourceforge.net;
 Sat, 28 Jan 2023 10:32:50 +0000
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by ams.source.kernel.org (Postfix) with ESMTPS id EC22DB8049B
 for <linux-f2fs-devel@lists.sourceforge.net>;
 Sat, 28 Jan 2023 10:32:39 +0000 (UTC)
...
X-Spam-Report: Spam detection software,
 ...
 32-bits binary call ioctl(F2FS_IOC_START_ATOMIC_REPLACE)
 will fail in 64-bits kernel. Fixes: 41e8f85a75fc ("f2fs: introduce
 F2FS_IOC_START_ATOMIC_REPLACE")
 Signed-off-by: Chao Yu <chao@kernel.org> --- fs/f2fs/file.c | 1 + 1 file
 changed, 1 insertion(+) 
...
X-Headers-End: 1pLiVt-001aZ8-Dp
Subject: [f2fs-dev] [PATCH] f2fs: fix to handle
