...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id D95069D5D8D
	for <lists+linux-f2fs-devel@lfdr.de>; Fri, 22 Nov 2024 11:58:53 +0100 (CET)
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  While traversing dir entries in dentry page, it's better to
 refresh current accessed page in lru list by using FGP_ACCESSED flag, otherwise,
 such page may has less chance to survive during memory recl [...] 
...
Cc: jaegeuk@kernel.org, zangyangyang1 <zangyangyang1@xiaomi.com>,
 linux-f2fs-devel@lists.sourceforge.net
Content-Type: multipart/mixed; boundary="===============9094991464721606493=="
