...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C279A2C8A6
	for <lists+linux-f2fs-devel@lfdr.de>; Fri,  7 Feb 2025 17:25:31 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1tgRAE-00031Z-Re;
	Fri, 07 Feb 2025 16:25:11 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <jaegeuk@kernel.org>) id 1tgRAB-00031R-T7
 for linux-f2fs-devel@lists.sourceforge.net;
 Fri, 07 Feb 2025 16:25:08 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=XWm+lXEzpaLQiq4HGcRTE8sIYk0UtlHWH0GONUD2Cqs=; b=Vy3cUMG9V9jiNEUq8qkZhKkbsu
 F4Uf/hnmx5ihm5VBHz+b9FCGdVlvtQSpp/UZ1zRJ2M4FQlArP9e3ZnKbZnRV6dqcWgfi23hLeszyw
 4CD7e+VYwgnsi19bJKVYFnEO9GuS1Egbak/FrlPf79HMzw0Fu6ADPtARUJ+ypKrugGCI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=XWm+lXEzpaLQiq4HGcRTE8sIYk0UtlHWH0GONUD2Cqs=; b=dHHWXywQmK8MHYJu+xfhUt6ssO
 mdqz3NOTH7myVa+gL7vQepH/zs90JCQRY99I/NqyqBlrtjtK6Hb9841lWKxj3ymR9cazB+1H36SnU
 Il5m7+azr1+wOVYOzOhH/Sbg3KUZiSbRh+NGpziFyQtnHwa/vVMOrmy9kqg1T3yKZFwk=;
Received: from nyc.source.kernel.org ([147.75.193.91])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1tgRAA-0003uN-Kz for linux-f2fs-devel@lists.sourceforge.net;
 Fri, 07 Feb 2025 16:25:08 +0000
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
 by nyc.source.kernel.org (Postfix) with ESMTP id CE3C5A435DF
 for <linux-f2fs-devel@lists.sourceforge.net>;
 Fri,  7 Feb 2025 16:23:09 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3ACF9C4CED1;
 Fri,  7 Feb 2025 16:24:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1738945495;
 bh=cJmD73vyOUkgCGl6svdCIgXnTfuKAJYA3DNJnC9LIVw=;
 h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
 b=
...
In-Reply-To: <20250207020441.3415568-1-chao@kernel.org>
X-Spam-Score: -2.5 (--)
X-Spam-Report: Spam detection software,
 ...
 Content preview: It seems you need to remove dummy f2fs_quota_sync() in
 fs/f2fs/super.c
 to fix the build error. 3204 int f2fs_quota_sync(struct super_block *sb,
 int type) 3205 { 3206 return 0; 3207 } On 02/07, Chao Yu wrote: > F2FS-fs
 (dm-59): checkpoint=enable has some unwritten data. > > [ cut here ] >
 WARNING:
 CPU: 6 PID: 8013 at fs/quota/dquot.c:691 dquot_writeback_dquo [...] 
...
X-Headers-End: 1tgRAA-0003uN-Kz
