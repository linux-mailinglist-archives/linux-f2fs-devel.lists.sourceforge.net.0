...
Received: from mail.lfdr.de
	...
	id 08E2Bdc+I2pilwEAu9opvQ
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	for <lists+linux-f2fs-devel@lfdr.de>; Fri, 05 Jun 2026 23:25:43 +0200
X-Original-To: lists+linux-f2fs-devel@lfdr.de
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id E0A4B64B5FF
	for <lists+linux-f2fs-devel@lfdr.de>; Fri, 05 Jun 2026 23:25:41 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=lists.sourceforge.net header.s=beta header.b=K7oV2b6g;
	dkim=fail ("body hash did not verify") header.d=sourceforge.net header.s=x header.b=nAJGZbZa;
	dkim=fail ("body hash did not verify") header.d=sf.net header.s=x header.b="T bwyqoN";
	dkim=fail ("body hash did not verify") header.d=gmail.com header.s=20251104 header.b=T3qEz6DS;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=uq7i+8/iMfh9u+5lm5bZsrQSdO+Tzdw6+LB4qprTc/Y=; b=K7oV2b6gu+IC7t/0n4rxUPR0Ce
	X90PKPaEFfd0DP28LoF79QyXDbcuaJzCSWE91fPDIegicWy0DgmUf5hZy114J2pCchsnGumm5Wt6i
	+lupgMFVcT9gLPhIUXct+HyqUAyxZMsUjTBQjjw3h+QtV+rAJVUT14epGscgHPLpygIw=;
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1wVc2j-0001tK-SO;
	Fri, 05 Jun 2026 21:25:30 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-3.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <daeho43@gmail.com>) id 1wVc2V-0001t5-7y
 for linux-f2fs-devel@lists.sourceforge.net;
 Fri, 05 Jun 2026 21:25:16 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=3sm9KsNtK+9swBEXw68MSMuiqeGBAr1ECLfAgVezL08=; b=nAJGZbZaoul0QFDiaHgGshkK56
 AjX6bnJaaso6XQXrKzeOd1JQy/hboPhjblVFdCD4r2SzfRi+xJekeiZq9kiSVW59mLjhawvSQJUeF
 j6UsHk1gLcWP6CX+4BDzNAQBPoXzK9l+u+Dat9D9loaO3iofbZaT1VWYQzaY28eQiXT0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=3sm9KsNtK+9swBEXw68MSMuiqeGBAr1ECLfAgVezL08=; b=T
 bwyqoNnfUJ0T6puBYuJMaLQMuW7SRIINQapISbmQPR6e+h8DCnCGH4ULdFldc+ui3At/OOGMH59IQ
 mMMizE9dUmPzdEKyjJPsJl9+KT7IwQ+WWCMypBoVmUvz1WT/1EGvYpPSiw5UpCjUF1hK422Y+WOho
 w8I4RrVWRHNnVsQQ=;
Received: from mail-dl1-f41.google.com ([74.125.82.41])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES128-GCM-SHA256:128) (Exim 4.95)
 id 1wVc2T-0006HP-KW for linux-f2fs-devel@lists.sourceforge.net;
 Fri, 05 Jun 2026 21:25:15 +0000
Received: by mail-dl1-f41.google.com with SMTP id
 a92af1059eb24-13721dfd471so3244457c88.1
 for <linux-f2fs-devel@lists.sourceforge.net>;
 Fri, 05 Jun 2026 14:25:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20251104; t=1780694708; x=1781299508; darn=lists.sourceforge.net;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:from:to:cc:subject:date:message-id:reply-to;
 bh=3sm9KsNtK+9swBEXw68MSMuiqeGBAr1ECLfAgVezL08=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20251104; t=1780694708; x=1781299508;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:x-gm-gg:x-gm-message-state:from:to:cc:subject:date
 :message-id:reply-to;
 bh=3sm9KsNtK+9swBEXw68MSMuiqeGBAr1ECLfAgVezL08=;
 b=
X-Forwarded-Encrypted: i=1;
 AFNElJ9EwoFXmsLM2KmgCIti1pDEYFc53pLJNzwMwnzc626SqMjzvhUOVti/MOjmHs8BCMC0Dg95Vt3muG5vGM60EWMN@lists.sourceforge.net
X-Gm-Message-State: AOJu0Yze9NPD/KQnZ9SvuqM+4N3FqSBIzEJz1VDA1LQaxcQNVaVXRcUh
 hQxlW3BWtHkQHFZ2eEQj3YKe1fm58SBhKRhzsx1UMV2e8xWxsI1hGuGYSnCYCw==
X-Gm-Gg: 
X-Received: by 2002:a05:7300:80ce:b0:2dd:6937:79d5 with SMTP id
 5a478bee46e88-3077af681eamr2969049eec.8.1780694708129; 
 Fri, 05 Jun 2026 14:25:08 -0700 (PDT)
Received: from daehojeong-desktop.mtv.corp.google.com
 ([2a00:79e0:2e7c:8:36b0:9062:f19d:e1c8])
 by smtp.gmail.com with ESMTPSA id
 5a478bee46e88-3074dba046esm8048036eec.9.2026.06.05.14.25.07
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 05 Jun 2026 14:25:07 -0700 (PDT)
From: Daeho Jeong <daeho43@gmail.com>
To: linux-kernel@vger.kernel.org, linux-f2fs-devel@lists.sourceforge.net,
 kernel-team@android.com
Date: Fri,  5 Jun 2026 14:25:04 -0700
Message-ID: <20260605212504.1080138-1-daeho43@gmail.com>
...
X-Headers-End: 1wVc2T-0006HP-KW
Subject: [f2fs-dev] [PATCH v2] f2fs: support dynamic include/exclude for
 device aliasing
...
---
 ...
 9 files changed, 517 insertions(+), 68 deletions(-)
...
index abcf6f486dd7..c26a57fc7a31 100644
--- a/fs/f2fs/file.c
+++ b/fs/f2fs/file.c
...
+
 ...
 {
 	struct inode *inode = file_inode(filp);
@@ -3599,6 +3628,230 @@ static int f2fs_ioc_get_dev_alias_file(struct file *filp, unsigned long arg)
 			(u32 __user *)arg);
 }
...
+
 ...
 {
 	struct inode *inode = file_inode(filp);
@@ -4721,8 +4974,14 @@ static long __f2fs_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
...
@@ -5447,7 +5706,10 @@ long f2fs_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
