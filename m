...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 095497044A1
	for <lists+linux-f2fs-devel@lfdr.de>; Tue, 16 May 2023 07:24:17 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1pynAR-0002zD-J9;
	Tue, 16 May 2023 05:24:12 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <ebiggers@kernel.org>) id 1pynAQ-0002z7-7m
 for linux-f2fs-devel@lists.sourceforge.net;
 Tue, 16 May 2023 05:24:11 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=4CjvXVXf64b4sHVEzwBue5u19RSyaYHk5kTi5gil2no=; b=dbkItzkmJUDK1vGnse6q4kjjcc
 ClHqZpTm5/2MGbVYXgnns6q4tK+vfPAaU7rw8Bhq1NUXh7JdrHLUlRVF4THXqNvjMbE3OxUhnrWNX
 MEBmzgHkb84u2b9LjIK3lgM2SEsypIe4pOcmbnswmQ3y/5lOQfzygWj2rv1SQpvtqq3s=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=4CjvXVXf64b4sHVEzwBue5u19RSyaYHk5kTi5gil2no=; b=E
 VfUyfSDUAdmAzc6PTRwk2qlH6wlTKQvUm2TBvlvcIETVYBf2j9pnIMpSlGcYfQDSBQ8kE/GC8nfC4
 GbIk71b+zW8FCrHxvB3PWgXMx0MaojZYKRelEbs9PG0v+5xB2F+HE1UPin8QwvFB4Q3pAgVCQoYX7
 VHcgkkI9A6zvLwmY=;
Received: from dfw.source.kernel.org ([139.178.84.217])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pynAN-0002Pi-Ph for linux-f2fs-devel@lists.sourceforge.net;
 Tue, 16 May 2023 05:24:11 +0000
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by dfw.source.kernel.org (Postfix) with ESMTPS id E7363622CE
 for <linux-f2fs-devel@lists.sourceforge.net>;
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  From: Eric Biggers <ebiggers@google.com> The "ahash" API,
 like the other scatterlist-based crypto APIs such as "skcipher", comes with
 some well-known limitations. First, it can't easily be used with vmalloc
 addresses. Second, the request str [...] 
...
X-Headers-End: 1pynAN-0002Pi-Ph
Subject: [f2fs-dev] [PATCH v2] fsverity: use shash API instead of ahash API
