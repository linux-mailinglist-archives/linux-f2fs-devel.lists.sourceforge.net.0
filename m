...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 49F8E723964
	for <lists+linux-f2fs-devel@lfdr.de>; Tue,  6 Jun 2023 09:41:06 +0200 (CEST)
...
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 ...
 id 1q6RJO-0001N2-Ta for linux-f2fs-devel@lists.sourceforge.net;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=Ol0fxj1SoRu64llcsuF5jrp946SnGnr76OCp1cdl0mI=; b=bI4saQ2ngf2C7DX34J2U+A7OTT
 DENmvluZFFL9zyWz9XxADHFtuA+yLRnqUPRMFolZiPRxbBPkBq/3RrEAJuhDHVCaEjbPGcHf9H41g
 t4O83DUnFzvLkZHUfebCbP2+XkuymLaisvO1T8XmHiE/q3F08H9RHrPhyLjc5CL5crW4=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=Ol0fxj1SoRu64llcsuF5jrp946SnGnr76OCp1cdl0mI=; b=F+IYrKRPsS7jfqHec0fxek8Nqs
 5n4Z3tUSB2+8pUOMZK5hg5p3ZXhNJFuiTJCkH/XwBagxJhVydb4crLi4k2mIDMMVWKRKFbKg+2NGS
 c9VnV9YmFYPEJJQ6Q+jQF39h0ctzALbzKbWcJxpBKL0oScsd92yfqwjfUFmeIilRHYYA=;
Received: from bombadil.infradead.org ([198.137.202.133])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1q6RJN-00CV7m-MH for linux-f2fs-devel@lists.sourceforge.net;
...
X-Spam-Report: Spam detection software,
 ...
 --- arch/um/drivers/ubd_kern.c | 4 ++-- arch/xtensa/platforms/iss/simdisk.c
 | 2 +- block/bdev.c | 14 +++++++------- drivers/block/amiflop.c | 2 +- drivers
...
X-Headers-End: 1q6RJN-00CV7m-MH
Subject: [f2fs-dev] [PATCH 10/31] block: remove the unused mode argument to
 ->release
