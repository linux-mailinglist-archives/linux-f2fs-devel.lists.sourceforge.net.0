...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 89B644F1BF
	for <lists+linux-f2fs-devel@lfdr.de>; Sat, 22 Jun 2019 01:58:51 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1heTQe-0006VP-EZ; Fri, 21 Jun 2019 23:58:48 +0000
...
Subject: [f2fs-dev] [PATCH 1/4] vfs: create a generic checking function for
 FS_IOC_SETFLAGS
