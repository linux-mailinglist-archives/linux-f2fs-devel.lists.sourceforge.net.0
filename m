...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id EF42362CBF
	for <lists+linux-f2fs-devel@lfdr.de>; Tue,  9 Jul 2019 01:44:13 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1hkdIo-0000kj-0y; Mon, 08 Jul 2019 23:44:10 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <jaegeuk@kernel.org>) id 1hkdIn-0000kc-3g
 for linux-f2fs-devel@lists.sourceforge.net; Mon, 08 Jul 2019 23:44:09 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=2WKCs/EylGcGsDURBi/36gNoRr51dNK0nbu7gE6o15M=; b=c0XPl3UIK4X9UiWlbgrwM59Du0
 kwCR8PGFEUpITH95UeOuSWUQbLFABbmu0eoJu4xnU2bv69SJaZGs/a3/zo07emW0ZZCma9Kt83RHu
 EISt0TCKo+9yb/lD8cxscP3+005UHcfGGdRtLhX/iwc16LlrWxNa0vb/d74eZYXHkeIU=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=2WKCs/EylGcGsDURBi/36gNoRr51dNK0nbu7gE6o15M=; b=SMLBVeQ+JfoQjblu0SaizBT7DK
 5SkRHixfcXPRJpGTS5zZF52FdtpSGjh+f60Ooye5L9c+k6ioJJ3FGVFAZTA1tZoGiLUiFyassvAty
 +3eWZISVY2lROXPJ9uaPfmRQNSZtXMG7z3jR27B6spAIt7MXDa8H0AyiQNsyRZDQcRRE=;
...
Received: from localhost (unknown [104.132.1.68])
 ...
 by mail.kernel.org (Postfix) with ESMTPSA id 9C10A20693;
 Mon,  8 Jul 2019 23:43:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1562629436;
 bh=bYgb9K3fiOBD3FdWWewAzCqRFb6EdR8MEKA4iUCP7zc=;
 h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
 b=ytMhSNyH0ZpWSehlF9aUxDvNUI/oameKkH4j1wjjJ+Ppq8dduKdGyPs//mqa8C47O
 ujwHLw462Mrna3cVz73BUvSwKeqHwnmOOWF2fdk4/wbE7Sd+J/R9iSPegQ5pewdFOo
 ba1XbaIwxBqjoWThZ4I/xnr/+58Qn4CR4st5JDdw=
Date: Mon, 8 Jul 2019 16:43:55 -0700
From: Jaegeuk Kim <jaegeuk@kernel.org>
To: Chao Yu <chao@kernel.org>
Message-ID: <20190708234355.GA21769@jaegeuk-macbookpro.roam.corp.google.com>
References: <15bb7741-7c2f-8dc2-065f-ba1fcaf22050@huawei.com>
 <20190705110356.GC8289@codeaurora.org>
 <20190705134859.GD8289@codeaurora.org>
 <0143261e-5592-1ee2-e09d-437d2a7eac22@kernel.org>
 <20190706013112.GE8289@codeaurora.org>
 <20190706013729.GF8289@codeaurora.org>
 <5932c199-1ee0-750a-0b25-25e237d95c9b@kernel.org>
 <a90106f0-b862-7938-b0b2-42492bbcd185@kernel.org>
 <20190706045032.GA99924@jaegeuk-macbookpro.roam.corp.google.com>
 <adbf514f-ee7f-1ff7-247f-a94d064e8efb@kernel.org>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <adbf514f-ee7f-1ff7-247f-a94d064e8efb@kernel.org>
...
X-Headers-End: 1hkdIl-00AxTd-49
...
> On 2019-7-6 12:50, Jaegeuk Kim wrote:
> > On 07/06, Chao Yu wrote:
> >> On 2019-7-6 10:10, Chao Yu wrote:
> >>> Hi Sahitya,
> >>>
...
> >>
> >> Sorry about that, I didn't check it out on upstream branch.
> > 
> > I guess we need this diff?
> 
> Yes, this diff should be merged into ("fsck.f2fs: check validity of nat
> journal") instead of ("fsck.f2fs: fix incorrect boundary of IS_VALID_NID()").
> 
> BTW, I think we'd better to use __is_valid_data_blkaddr/f2fs_is_valid_blkaddr to
> check blkaddr in different condition like we did in kernel.

Sorry, it is in -master. Let me keep going with this.
