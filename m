...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D2EE6EC51F
	for <lists+linux-f2fs-devel@lfdr.de>; Mon, 24 Apr 2023 07:50:24 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1pqp5i-0006N0-Fi;
	Mon, 24 Apr 2023 05:50:23 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95) (envelope-from
 <BATV+e16e2fc4419b117693a1+7183+infradead.org+hch@bombadil.srs.infradead.org>)
 id 1pqp5h-0006Mq-2A for linux-f2fs-devel@lists.sourceforge.net;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=FmYSiKdP5y3EH7nBXTpf8bIFKknqbI4piiyOLlTcqUc=; b=C/n1jo776sC/2b1o7aVA9tzVtJ
 +mY479La2gt0GIs2//p1nYgyOHEdxr0eMsfMWkXP+wMAVHOfXJBNo7nJfWFzcSt9vXxHWFfiLXOqm
 hQtMKg8Jwc/7GsREtWmJ/WiBwLcxbSe3oszTjfzkfTMAMbkmXaWyXW+qywl54iFuVTR8=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=FmYSiKdP5y3EH7nBXTpf8bIFKknqbI4piiyOLlTcqUc=; b=FjyA9na8EBDPJ3OuEZGX60e/Lk
 CBYNLzIna46axTeIa7nJcUWFaxtEcZPrRgjk2BJwJbQyFrKVql01wZP631Vspn3cGdt1fvtSaI1/y
 cmnd7Xd3/3ZoR0m0X++ZFDhoHpOMOL1ejwg+1DJLdrY+KRkzdIEC2+xS+gf7VdtFnZcQ=;
Received: from bombadil.infradead.org ([198.137.202.133])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pqp5h-0003Vk-Er for linux-f2fs-devel@lists.sourceforge.net;
 Mon, 24 Apr 2023 05:50:21 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Remove the no needed plug in blkdev_write_iter. For direct
 I/O that issues more than a single I/O,
 the plug is already done in __blkdev_direct_IO, 
 and for synchronous buffered writes, the plug is done [...] 
...
X-Headers-End: 1pqp5h-0003Vk-Er
Subject: [f2fs-dev] [PATCH 13/17] block: don't plug in blkdev_write_iter
