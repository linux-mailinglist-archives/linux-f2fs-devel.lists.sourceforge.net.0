...
Received: from mail.lfdr.de
	...
	id N4pwAQrAIWogNAEAu9opvQ
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	for <lists+linux-f2fs-devel@lfdr.de>; Thu, 04 Jun 2026 20:12:26 +0200
X-Original-To: lists+linux-f2fs-devel@lfdr.de
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id E69D064286B
	for <lists+linux-f2fs-devel@lfdr.de>; Thu, 04 Jun 2026 20:12:24 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=lists.sourceforge.net header.s=beta header.b=iNoW+CZF;
	dkim=fail ("body hash did not verify") header.d=sourceforge.net header.s=x header.b=KJLcoONF;
	dkim=fail ("body hash did not verify") header.d=sf.net header.s=x header.b="K JuI9Cx";
	dkim=fail ("body hash did not verify") header.d=gmail.com header.s=20251104 header.b=CyORbrvv;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=GDRizcGnO0Zhh/bkvqgKmLfBB/mZ6eGMy4uzhER3tBQ=; b=iNoW+CZFwBN976iF8nYVzVgi2y
	QmwCzTWujiP+59ZCT1JRK5iik679+ko8Q2tjj4tcEkS+YHONcGnCSjUCm9DgPFd1fMS8t4Cv5YzdF
	dkmu29c/8tEANRVfqCTYW0JvkAZvjAXLeLS7yaiTaNvceXRzlKS/EDREJ3232ljpZdRU=;
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1wVCYB-00042G-8B;
	Thu, 04 Jun 2026 18:12:12 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <daeho43@gmail.com>) id 1wVCY8-000429-7h
 for linux-f2fs-devel@lists.sourceforge.net;
 Thu, 04 Jun 2026 18:12:09 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=Fs+IWFFI8oXyIIHozQF3G/wvn/Qh2hAWegCWE5vpSDM=; b=KJLcoONFVyAsFVhhoktrDlUMXQ
 eBIVLz8pYl0ioWJLfN3sD46TyvbSSwZv2Wt3gk9fzaJ1/vteTLS6PqnS8w0a+kI+MfHYAkPRF0u99
 xFudEPJtkr691KOsrfeRFNtfvVIs3Uh8EOECdexaS9D16J9S55CBgBC96opDr9T3/gWo=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=Fs+IWFFI8oXyIIHozQF3G/wvn/Qh2hAWegCWE5vpSDM=; b=K
 JuI9CxtvLlJKYdEwWdelX3k9I7AgU7ICj2VmNWv11Nppw+9eNze89RqnaGFV8KTBHrVgDVNIL1UaP
 XkLDS1y31RhD5thxcTunRTPftkimQ2K5vdR9ubOmOZgpZWyVfe/jJBVZdKfN17C+UlX/6bMoIXWkM
 LNPHOOEaD5K1wcTI=;
Received: from mail-dl1-f49.google.com ([74.125.82.49])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES128-GCM-SHA256:128) (Exim 4.95)
 id 1wVCY3-00064i-AZ for linux-f2fs-devel@lists.sourceforge.net;
 Thu, 04 Jun 2026 18:12:09 +0000
Received: by mail-dl1-f49.google.com with SMTP id
 a92af1059eb24-137eed84fc6so2761895c88.0
 for <linux-f2fs-devel@lists.sourceforge.net>;
 Thu, 04 Jun 2026 11:12:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20251104; t=1780596722; x=1781201522; darn=lists.sourceforge.net;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:from:to:cc:subject:date:message-id:reply-to;
 bh=Fs+IWFFI8oXyIIHozQF3G/wvn/Qh2hAWegCWE5vpSDM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20251104; t=1780596722; x=1781201522;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:x-gm-gg:x-gm-message-state:from:to:cc:subject:date
 :message-id:reply-to;
 bh=Fs+IWFFI8oXyIIHozQF3G/wvn/Qh2hAWegCWE5vpSDM=;
 b=
X-Forwarded-Encrypted: i=1;
 AFNElJ8hZpBQbua26QxQyYicvZE9wdyy4BRe5cFUyr138HVHNRh29WiIjJxZr6t5ZqtQASW2KxNK7iaoyjx5jkP8SbYT@lists.sourceforge.net
X-Gm-Message-State: AOJu0YwiQJKRRkGK3um1pwN6o5nPy5xsn/sHjX9z5h570IsPU3/jj8am
 4Y/MHgmvWkqvFu2POKuEZcQtZPRpsCHXLILRsj4wyzkVmUXrEa7dXDdG
X-Gm-Gg: 
X-Received: by 2002:a05:7300:2142:b0:304:3c33:7ad4 with SMTP id
 5a478bee46e88-3074faa3c64mr4297728eec.13.1780596721055; 
 Thu, 04 Jun 2026 11:12:01 -0700 (PDT)
Received: from daehojeong-desktop.mtv.corp.google.com
 ([2a00:79e0:2e7c:8:1410:c629:9bb9:ab1d])
 by smtp.gmail.com with ESMTPSA id
 5a478bee46e88-3074dea8e8csm5542587eec.16.2026.06.04.11.12.00
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 04 Jun 2026 11:12:00 -0700 (PDT)
From: Daeho Jeong <daeho43@gmail.com>
To: linux-kernel@vger.kernel.org, linux-f2fs-devel@lists.sourceforge.net,
 kernel-team@android.com
Date: Thu,  4 Jun 2026 11:11:54 -0700
Message-ID: <20260604181154.70349-1-daeho43@gmail.com>
...
X-Spam-Report: Spam detection software,
 ...
 exclude or include specific devices from the filesystem's free pool at runtim
...
X-Headers-End: 1wVCY3-00064i-AZ
Subject: [f2fs-dev] [PATCH] f2fs: support dynamic include/exclude for device
 aliasing
...
---
 ...
 9 files changed, 511 insertions(+), 68 deletions(-)
...
index abcf6f486dd7..f6dfb2fe8f11 100644
--- a/fs/f2fs/file.c
+++ b/fs/f2fs/file.c
...
+
 	if ((iflags ^ masked_flags) & F2FS_CASEFOLD_FL) {
 		if (!f2fs_sb_has_casefold(F2FS_I_SB(inode)))
 			return -EOPNOTSUPP;
@@ -2197,6 +2213,7 @@ static const struct {
...
+		F2FS_DEVICE_ALIAS_FL)
 ...
 #define F2FS_SETTABLE_FS_FL (		\
 		FS_COMPR_FL |		\
@@ -2663,6 +2681,17 @@ static int f2fs_ioc_get_encryption_policy(struct file *filp, unsigned long arg)
...
+
 ...
 {
 	struct inode *inode = file_inode(filp);
@@ -3599,6 +3628,224 @@ static int f2fs_ioc_get_dev_alias_file(struct file *filp, unsigned long arg)
 			(u32 __user *)arg);
 }
...
+
 ...
 {
 	struct inode *inode = file_inode(filp);
@@ -4721,8 +4968,14 @@ static long __f2fs_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
...
@@ -5447,7 +5700,10 @@ long f2fs_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
