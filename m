...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A793C3E279E
	for <lists+linux-f2fs-devel@lfdr.de>; Fri,  6 Aug 2021 11:44:38 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1mBwP1-0004DQ-Lx; Fri, 06 Aug 2021 09:44:31 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <chao@kernel.org>) id 1mBwP0-0004Co-31
 for linux-f2fs-devel@lists.sourceforge.net; Fri, 06 Aug 2021 09:44:30 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=mUytiYJeHHEK7BAoOotAdH9fI3hpBbxh1G0rj6jhkb0=; b=ZmPPxXRRsiv1YN6nl9UMfjm+2k
 0VA6FiHiiwve3eSuIC7zYRrjPj/dIcosN9C0ZGq0uSeoDmIdQbQpZPtv6LZROZwxdUmj8ydZFFita
 vFEJY2gpfval+tFfQUaSz3ig6Q6SgmUYyhc36v+veGKBB6UU7HdlOFMe802zu25JTV1g=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=mUytiYJeHHEK7BAoOotAdH9fI3hpBbxh1G0rj6jhkb0=; b=T
 QYMvxkhq8M4MOQKPkYWCMNCTfWrZ+7zY2baikulpXgC2J2jpreAlnAq/POdW+zsxYsREaOEEuTW2l
 B/YwexGxptjmWABWwU3HXVQmilQCxO6CuefyL94g/MsYDi51fwVPTmTeWHtpmC+Ge1vhIE11thcsp
 9vaPoz4b8Vmq4DyY=;
Received: from mail.kernel.org ([198.145.29.99])
 ...
 id 1mBwOq-000621-Ng
 for linux-f2fs-devel@lists.sourceforge.net; Fri, 06 Aug 2021 09:44:30 +0000
Received: by mail.kernel.org (Postfix) with ESMTPSA id D2B2560F43;
 Fri,  6 Aug 2021 09:44:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1628243043;
 bh=LeosbKMyT2lTbnO8MSPcCIPa7lH2jrRY5DMcp5xJkPk=;
 h=From:To:Cc:Subject:Date:From;
 b=
From: Chao Yu <chao@kernel.org>
To: jaegeuk@kernel.org
Date: Fri,  6 Aug 2021 17:43:57 +0800
Message-Id: <20210806094357.55549-1-chao@kernel.org>
...
X-Headers-End: 1mBwOq-000621-Ng
Subject: [f2fs-dev] [PATCH v2 2/2] f2fs: support fault injection for
...
---
v2:
- fix to use FAULT_SLAB_ALLOC correctly.
...
index d1c322b3ddaf..4b6ea498a1e0 100644
--- a/fs/f2fs/f2fs.h
+++ b/fs/f2fs/f2fs.h
@@ -54,6 +54,7 @@ enum {
 	FAULT_CHECKPOINT,
