...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 628B6506F01
	for <lists+linux-f2fs-devel@lfdr.de>; Tue, 19 Apr 2022 15:53:28 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1ngoIF-0004JI-Ac; Tue, 19 Apr 2022 13:53:21 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <brauner@kernel.org>) id 1ngoIE-0004J8-AA
 for linux-f2fs-devel@lists.sourceforge.net; Tue, 19 Apr 2022 13:53:20 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=f4mp2hqqDGElmLPPas+7vyqn1MjNUakIo+PxxBlcX6E=; b=DvrHMtHzLH9gV2Q2vYKIOBhxSX
 GJAMYEVtpwm9FxxH4c4DTMzx3xsae02IntBD3JS6CFW0oNfLXzCpnR4zqwI7X8DQse6FPsIxf7Ypd
 a9BagwCNK1zgQ1popX8vn1wO+Pgip0F9QM5Amrv2pACV/lVkxQOIcZt2U+IeSaEk7xc8=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=f4mp2hqqDGElmLPPas+7vyqn1MjNUakIo+PxxBlcX6E=; b=N7HTO8pheBHWpwGivUDBqMik2s
 FnR7fltH/COy33kEDX+kWJLrBtFY//2ZZJRGoj0uVX+rVAG99U5Js4NT/3PvdEck/pWSDFxxRQK3k
 GrMyvPO83Dc2p+7UCq/XAxptt/Cg2//MrUty/Qe2xCk6BuP4B9EfapchzxVM0fwf/vV0=;
...
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 ...
 by dfw.source.kernel.org (Postfix) with ESMTPS id CAD0E6173E;
 Tue, 19 Apr 2022 13:53:11 +0000 (UTC)
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  On Tue, Apr 19, 2022 at 07:47:09PM +0800, Yang Xu wrote: >
 Since xfs_generic_create only calls xfs_set_acl when enable this kconfig,
 we > don't need to call posix_acl_create for the !CONFIG_XFS_POSIX_ [...]
...
X-Headers-End: 1ngoI9-003x8U-7C
