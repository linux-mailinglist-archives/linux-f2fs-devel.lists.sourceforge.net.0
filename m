...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A0D14682258
	for <lists+linux-f2fs-devel@lfdr.de>; Tue, 31 Jan 2023 03:45:07 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1pMgdt-0007wl-Cg;
	Tue, 31 Jan 2023 02:45:03 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <chao@kernel.org>) id 1pMgds-0007wf-5c
 for linux-f2fs-devel@lists.sourceforge.net;
 Tue, 31 Jan 2023 02:45:02 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=ivpfDZ5zsENtlw4/fz6s/y3qfl9k2JCqpKXN/aelaSs=; b=VS6JRbRqpAHDVNiG4GB0TO/NZO
 Rjk4XGfoqGoDpQ0s0IhHRkElfS17uEh+gDq5TdGGukyLmErJJFMtGirX6a3Qiw8ipA/yXvPK/VF2c
 JHFQjpaJnDynCaF4lmKCqyyZsq9jfYgoKUSWj9qGB6+WL0C/KmQv95Fvh5eAc1yBJdZM=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=ivpfDZ5zsENtlw4/fz6s/y3qfl9k2JCqpKXN/aelaSs=; b=d
 60gE9GL9imuLkXmilwNrhbnWbN7aZfUP/fWAchhF7dtuBwIDX7wb1kffPLMwcGINgh4qUd208bi47
 pMiNE9HVB1YAGxXIt+R1w93qSHWIF3lqvjlp17HwfLhLqGSTvkDHGCyHVZD3H/79WZuVFeh7hBe+4
 KhVqscnCpepYvjcM=;
Received: from dfw.source.kernel.org ([139.178.84.217])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pMgdo-0007Jh-2K for linux-f2fs-devel@lists.sourceforge.net;
 Tue, 31 Jan 2023 02:45:02 +0000
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by dfw.source.kernel.org (Postfix) with ESMTPS id A1EC661231
 for <linux-f2fs-devel@lists.sourceforge.net>;
 Tue, 31 Jan 2023 02:44:54 +0000 (UTC)
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: Parsing sync/rw type from bio inside
 iostat_update_and_unbind_ctx()
 to avoid unnecessary parameters. Signed-off-by: Chao Yu <chao@kernel.org>
 --- - this patch is based on [PATCH v3] f2fs: use iostat_lat_type directly
 as a parameter in the iostat_update_and_unbind_ctx() fs/f2fs/data.c | 4 ++--
 fs/f2fs [...] 
...
X-Headers-End: 1pMgdo-0007Jh-2K
Subject: [f2fs-dev] [PATCH] f2fs: clean up parameters of
 iostat_update_and_unbind_ctx()
