...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A3237712A9B
	for <lists+linux-f2fs-devel@lfdr.de>; Fri, 26 May 2023 18:27:38 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1q2aHu-0003mL-G3;
	Fri, 26 May 2023 16:27:34 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <jaegeuk@kernel.org>) id 1q2aHq-0003mD-GG
 for linux-f2fs-devel@lists.sourceforge.net;
 Fri, 26 May 2023 16:27:30 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=JChbvqsK0yxqceJDUFuVzMl+lY/UmVMxpvLKq53Cct4=; b=f8azeRLfcEyMgYvXfHftFinpyj
 Ps8ZTmhDsdXTQ8ynqwezYanOEhBnVgErOlsyqmYCpDpiV5KpgudGT9cHFBlVIHS9Po1KA2z81zSAj
 d6pQwpTzG4+bU9aDO8HLFRu9CCCVapZNC+v3Q2wlqiY/CuqvaHLcAge7nKIQDguKL3g8=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=JChbvqsK0yxqceJDUFuVzMl+lY/UmVMxpvLKq53Cct4=; b=CZtIFe+iJAo3roKlvUK0uvjBKw
 IwBxx2Fv1nryLBRt0X3yvCLDPMrevuMszm1HWngGJ+Fi2eUJJ7VHRU+Rja5MSOepfV52Gla9+sJBR
 qIqnUYrySbNO76dgmH7K4IWbWXe/KDSnQJuJuKFcgbS7AhCCT9VZ0rdeyS0NW1MrEKWc=;
Received: from dfw.source.kernel.org ([139.178.84.217])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1q2aHp-0001lO-C3 for linux-f2fs-devel@lists.sourceforge.net;
 Fri, 26 May 2023 16:27:30 +0000
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by dfw.source.kernel.org (Postfix) with ESMTPS id E6F9D60DE9
 for <linux-f2fs-devel@lists.sourceforge.net>;
 Fri, 26 May 2023 16:27:23 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 43D2DC433D2;
 Fri, 26 May 2023 16:27:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1685118443;
 bh=wvsROcyfqFMfEHCE4RxM4rTwVMZV8S/y938dgunBnt0=;
 h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
 b=
Date: Fri, 26 May 2023 09:27:21 -0700
From: Jaegeuk Kim <jaegeuk@kernel.org>
To: Chao Yu <chao@kernel.org>
Message-ID: <ZHDd6REAhqwG16ic@google.com>
References: <20230526032357.2912540-1-chao@kernel.org>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20230526032357.2912540-1-chao@kernel.org>
X-Spam-Score: -5.9 (-----)
X-Spam-Report: Spam detection software,
 ...
 Content preview: Applying: mkfs.f2fs: refactor format flow for cleanup
 .git/rebase-apply/patch:449:
 trailing whitespace. .git/rebase-apply/patch:652: trailing whitespace.
 .git/rebase-apply/patch:747:
 trailing whitespace. struct f2fs_node *raw_node = NULL; error: patch failed:
 include/f2fs_fs.h:494 error: include/f2fs_fs.h: patch does not apply error:
 patch failed: mkfs [...] 
...
X-Headers-End: 1q2aHp-0001lO-C3
