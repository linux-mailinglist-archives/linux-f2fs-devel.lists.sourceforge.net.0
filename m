...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F0A785275B
...
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 ...
 (envelope-from <krisman@suse.de>) id 1rZiJ9-0001vQ-P3
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=tlx4z3N508ykO+IPN4KGQgLY91vQLkOc0l8vpLCa86g=; b=l4tfuSTBXc96b7U5uZIWGx8Nf2
 /E79vEou+CP+KlIVYju2Yln3gOTZhx91FvVYF/4TIftK3ETS2H8wKFPyFfAOtxudlUYdwKu/FJehv
 28d3VNBlsdQxSYK2rTdV+scqnr4ebfWYofJnDiotAazlnb4EL47T2VkKSjU3MWMxnEcY=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=tlx4z3N508ykO+IPN4KGQgLY91vQLkOc0l8vpLCa86g=; b=ZpTXv2B3F0YfBd7jGLLvXrxerN
 D2KUIdRlZi4lqMOLPTIUyIIHq2UWVMUDXFjPMR/GBFZCZ66ZLY/VueNgIviAhY0xxuvtls13X1OB4
 QOzJTjAaOY3+uIKLRRK5a6iHclROiU9qH3Zr5Lgb1zqlj0+3RY+4aKCcfGoda0xgK+1E=;
Received: from smtp-out1.suse.de ([195.135.223.130])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES128-GCM-SHA256:128) (Exim 4.95)
 id 1rZiJ7-00024X-Ti for linux-f2fs-devel@lists.sourceforge.net;
...
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id h+vcImPQymUseAAAD6G6ig
...
X-Spamd-Result: default: False [3.70 / 50.00]; ARC_NA(0.00)[];
 ...
 RCVD_TLS_ALL(0.00)[]; BAYES_HAM(-0.00)[17.33%]
X-Spam-Flag: NO
X-Spam-Score: -2.5 (--)
...
X-Headers-End: 1rZiJ7-00024X-Ti
Subject: [f2fs-dev] [PATCH v6 08/10] f2fs: Configure dentry operations at
