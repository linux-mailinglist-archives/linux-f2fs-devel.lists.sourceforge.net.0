...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id EBD1C2E1A25
	for <lists+linux-f2fs-devel@lfdr.de>; Wed, 23 Dec 2020 09:49:04 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <linux-f2fs-devel-bounces@lists.sourceforge.net>)
	id 1krzpH-0000xk-Te; Wed, 23 Dec 2020 08:48:55 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <yuchao0@huawei.com>) id 1krzpG-0000xd-5Y
 for linux-f2fs-devel@lists.sourceforge.net; Wed, 23 Dec 2020 08:48:54 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=vcDoX4rEl+XUJIsXYCE3G3aEmLiTxTp/6RVpIiJYEqo=; b=I3wooqCQlY7zwNQivYSJI1AXBD
 tBjyX3Rqv4kFHKl9WFKaM2y/f1+FwCpHge0tjUZqdG7OJQuARxNBFLyUK8fyKZvbrG4aFvxJZJBob
 PkQrXGbD4dm+bmLPCiBHVMucNMIXFn5iR3nWyQUjlY5wqLtlzk0n9We/63iXyENQsJyY=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=vcDoX4rEl+XUJIsXYCE3G3aEmLiTxTp/6RVpIiJYEqo=; b=LyANCDl+bP53YLxlu0Zb1hqEiw
 TzxBQkzYQoO+zNfwPQcUo1fgjWR3vg3I2bgNxwF88BK1f6Yt3Yt9DuCKsDwwkdIYvmZKiEe+w9dfw
 DG72GZLs1Kiu6J4fnkGG18KQV69aLPzYVOo2zcaAjiHJs6oD6oAZus+fEBiSczSQwwiU=;
...
Received: from DGGEMS403-HUB.china.huawei.com (unknown [172.30.72.59])
 by szxga05-in.huawei.com (SkyGuard) with ESMTP id 4D16KW0jnbzhwjg;
 Wed, 23 Dec 2020 16:47:43 +0800 (CST)
Received: from [10.136.114.67] (10.136.114.67) by smtp.huawei.com
 (10.3.19.203) with Microsoft SMTP Server (TLS) id 14.3.498.0; Wed, 23 Dec
 2020 16:48:20 +0800
...
Message-ID: <41c614ab-6937-3ff0-53e6-4c0b74fa3d56@huawei.com>
...
X-Headers-End: 1krzp0-0064lm-Dl
...
>>>>>>
>>>>>> newattrs.ia_mode =3D (mode & S_IALLUGO) | (inode->i_mode & ~S_IALLUG=
O);
>>>>>
>>>>> Hi Chao,
>>>>>
...
Yeah, there is no such restriction on what order we update i_mode and acl, =
my
concern is to keep line with original implementation strategy of f2fs acl p=
art.
...
>>  =A0=A0=A0=A0=A0=A0=A0=A0 err =3D posix_acl_chmod(inode, f2fs_get_inode_=
mode(inode));
...
>>  =A0=A0=A0=A0=A0=A0=A0=A0=A0=A0=A0=A0 clear_inode_flag(inode, FI_ACL_MOD=
E);
...
>>>>  =A0=A0=A0=A0=A0=A0=A0=A0=A0 name_index =3D F2FS_XATTR_INDEX_POSIX_ACL=
_ACCESS;
...
>>>>
>>>>  =A0=A0=A0=A0=A0=A0=A0=A0=A0 if (value && f2fs_xattr_value_same(here, =
value, size))
...
>>>>  =A0=A0=A0=A0=A0=A0=A0=A0=A0=A0=A0=A0=A0 !strcmp(name, F2FS_XATTR_NAME=
_ENCRYPTION_CONTEXT))
...
>>>>  =A0=A0=A0=A0=A0=A0=A0=A0=A0 set_sbi_flag(F2FS_I_SB(inode), SBI_NEED_C=
P);
>>>> +
>>>> +same:
>>>> +=A0=A0=A0 if (is_inode_flag_set(inode, FI_ACL_MODE)) {
